...
// Извлечение главных файлов из vower-components
...
//Чиcтый билд, удаляем /build
gulp.task('dbuild', function() {
	return del(['build/']);
});

gulp.task("cbuild", ['dbuild', 'copy-bower-dep', 'stylus', 'html', 'images', 'plugins', 'copy']);

//Обычный билд, без удаления
gulp.task("build", ['copy-bower-dep', 'stylus', 'html', 'images', 'plugins', 'copy']);

//Стандартный таск плюс запуск сервера
