$(document).ready(function () {
	...
	$(".work-items-big").on('click', function (e) {
		if ($(e.target).is($('.work-item-preview').find("*")) || $(e.target).is($('.work-item-preview'))) {} else {
			$(".work-items-big").fadeOut();
		}
	});
	...
	var rndNumber = function () {
		...
		colorsArr = ["bg-blue", "bg-yellow", "bg-pink", "bg-green", "bg-white"],
		color;
