$(document).ready(function () {
	...
	// Init controller
	var controller = new ScrollMagic.Controller({refreshInterval: 200,
		globalSceneOptions: {
			triggerHook: .69
		}
	});
	...
	var scene1 = new ScrollMagic.Scene({
			triggerElement: '.projects', duration: $('.projects').height()
		})
	...
	var scene2 = new ScrollMagic.Scene({
			triggerElement: '.skills', duration: $('.skills').height()
		})
	...
	var scene3 = new ScrollMagic.Scene({
			triggerElement: '.footer-wrapper', duration: $('.footer-wrapper').height()
		})
